...
namespace CampoMinato2
{
    public partial class FPartita : Form
    {
        ...
        private void dgv_main_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            if (cell.Value?.ToString() == "F")
            {
                // Disegna solo lo sfondo
                e.PaintBackground(e.ClipBounds, true);

                // Disegna l'immagine centrata senza il testo "F"
                ...
                e.Graphics.DrawImage(imgFlag, imgRect);

                // Segnala che abbiamo gestito il disegno, non fare il disegno standard
                e.Handled = true;
            }
        }
